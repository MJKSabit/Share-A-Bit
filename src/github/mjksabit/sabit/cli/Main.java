...
public class Main {
    ...
    static volatile ArrayList<Sender.ReceiverInfo> listReceivers;
...
//                    try (Sender sender = new Sender(name, (SharedInfo serverInfo) -> {
//                        try {
...
//                    });) {
//                        sender.sendPresence();
//                        Sender.ReceiverInfo data = listReceivers.get(selectReceiver());
//
